...
var NextJsPlugin = class {
  ...
  withApp(AppComponent) {
    ...
    return class AppWithTsApplication extends import_react.default.Component {
      ...
      render() {
        return /* @__PURE__ */ import_react.default.createElement(AppComponent, { ...this.props });
      }
    };
  }
  /**
...
function createNextJsPlugin(app, options = {}) {
...
export { NextJsPlugin, createNextJsPlugin, nextjs };
