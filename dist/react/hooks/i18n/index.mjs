...
function useLocale() {
  const translator = useTranslator();
  const [locale, setLocaleState] = (0, import_react3.useState)(translator.getLocale());
  const setLocale = (0, import_react3.useCallback)(
    (newLocale) => {
...
export { useHasTranslation, useLocale, useTranslate, useTranslator };
