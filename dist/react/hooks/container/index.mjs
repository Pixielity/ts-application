...
var ContainerContext = (0, import_react.createContext)(void 0);

// src/react/hooks/container/use-container.ts
function useContainer() {
  const context = (0, import_react2.useContext)(ContainerContext);
  if (context === void 0) {
...
function withServices(Component, services) {
  return function WithServices(props) {
    ...
    return /* @__PURE__ */ import_react3.default.createElement(Component, { ...props, ...resolvedServices });
  };
}
...
export { useContainer, useResolve, withServices };
