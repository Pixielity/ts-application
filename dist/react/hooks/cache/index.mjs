...
function useCachedData(key, fetcher, ttl = 60, options = {}) {
  ...
  const [loading, setLoading] = (0, import_react3.useState)(!options.skipInitialFetch);
  const [error, setError] = (0, import_react3.useState)(null);
  const [lastUpdated, setLastUpdated] = (0, import_react3.useState)(null);
  ...
  const invalidate = (0, import_react3.useCallback)(async () => {
...
export { useCacheValue, useCachedData, useICache, useMultiCacheValues };
