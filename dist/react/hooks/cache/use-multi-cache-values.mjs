...
function useMultiCacheValues(keys, defaultValues) {
  ...
  const fetchValues = (0, import_react3.useCallback)(async () => {
    setLoading(true);
    try {
  ...
  const setCacheValues = (0, import_react3.useCallback)(
    async (newValues, ttl) => {
      try {
  ...
  const removeCacheValues = (0, import_react3.useCallback)(async () => {
    try {
...
//# sourceMappingURL=use-multi-cache-values.mjs.map
//# sourceMappingURL=use-multi-cache-values.mjs.map