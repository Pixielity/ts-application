...
function AppProvider({ app, children }) {
  return /* @__PURE__ */ import_react3.default.createElement(AppContext.Provider, { value: app }, children);
}
...
function ContainerProvider({
  ...
  return /* @__PURE__ */ import_react4.default.createElement(ContainerContext.Provider, { value: container }, children);
}
...
export { AppProvider, ContainerProvider };
